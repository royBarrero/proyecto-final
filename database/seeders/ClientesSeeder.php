...
class ClientesSeeder extends Seeder{
    public function run(){
        ...
        DB::table('clientes')->insert(['id'=> '24', 'nombre'=> 'Samuel Torrico', 'direccion'=> null, 'telefono'=> '74559621', 'idusuarios'=> '26', 'activo'=> '1'] );
        DB::table('clientes')->insert(['id'=> '23', 'nombre'=> 'Belisario Landa', 'direccion'=> null, 'telefono'=> '66254417', 'idusuarios'=> '25', 'activo'=> '1'] );
        //DB::table('clientes')->insert(['id'=> '30', 'nombre'=> 'Josue Vargas', 'direccion'=> null, 'telefono'=> null, 'idusuarios'=> '32', 'activo'=> '1'] );
        DB::table('clientes')->insert(['id'=> '10', 'nombre'=> 'Daniel Suárez', 'direccion'=> 'Av. Alemana 99', 'telefono'=> '7894570', 'idusuarios'=> null, 'activo'=> '1'] );
        DB::table('clientes')->insert(['id'=> '11', 'nombre'=> 'Cristian Huari', 'direccion'=> 'Av. Siempre Viva 123', 'telefono'=> '7133571', 'idusuarios'=> null, 'activo'=> '1'] );
        DB::table('clientes')->insert(['id'=> '28', 'nombre'=> 'Jose Aguirre', 'direccion'=> null, 'telefono'=> '66852470', 'idusuarios'=> '30', 'activo'=> '1'] );
        ...
        //DB::table('clientes')->insert(['id'=> '32', 'nombre'=> 'Wilber Ortiz', 'direccion'=> null, 'telefono'=> '68990086', 'idusuarios'=> '34', 'activo'=> '1'] );
        DB::table('clientes')->insert(['id'=> '31', 'nombre'=> 'Santiago Justo Huari', 'direccion'=> null, 'telefono'=> '67791098', 'idusuarios'=> '33', 'activo'=> '1'] );
        DB::table('clientes')->insert(['id'=> '29', 'nombre'=> 'Melquiades Ancalle', 'direccion'=> null, 'telefono'=> '78556200', 'idusuarios'=> '31', 'activo'=> '1'] );
        DB::table('clientes')->insert(['id'=> '33', 'nombre'=> 'Luis Morales', 'direccion'=> null, 'telefono'=> null, 'idusuarios'=> '35', 'activo'=> '1'] );
        DB::table('clientes')->insert(['id'=> '37', 'nombre'=> 'Pepe12 Gonzales', 'direccion'=> null, 'telefono'=> null, 'idusuarios'=> '39', 'activo'=> '1'] );
    }
}